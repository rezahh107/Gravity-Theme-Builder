...
gtb_srwf_runtime_diagnostic_enqueue( $form, false );
check( count( $scripts ) === 1, 'diagnostic did not load for admin target without query flag' );
...
check( strpos( file_get_contents( __DIR__ . '/../diagnostic/srwf-runtime-diagnostic.php' ), '$_GET' ) === false, 'query-string activation remains in diagnostic delivery' );

echo "PASS: diagnostic v0.3 delivery contract\n";

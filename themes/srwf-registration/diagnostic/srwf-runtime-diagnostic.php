...
/**
 * Load the local read-only diagnostic for an administrator whenever the SRWF target
 * form is rendered. There is no query-string gate, server endpoint, or remote transport.
 *
 * @param array<string,mixed> $form    Gravity Forms form object.
